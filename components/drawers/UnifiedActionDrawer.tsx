        ...
        >
            {loading ? (
                ...
                <div className="space-y-5">
                    ...
                    <div className="flex flex-wrap gap-2 animate-in fade-in slide-in-from-bottom-2 duration-500 fill-mode-both">
                        ...
                        {primaryEmail && (
                            <a
                                ...
                                className="flex-1 min-w-[120px] flex items-center justify-center gap-2 px-4 py-3 bg-white border border-indigo-200 hover:border-indigo-300 hover:bg-indigo-50 text-indigo-700 rounded-xl font-medium text-sm shadow-sm transition-all duration-200 hover:shadow-md"
                            >
                        ...
                        {(contact?.linkedin || company?.website) && (
                            <a
                                ...
                                className="flex items-center justify-center gap-2 px-4 py-3 bg-white border border-slate-200 hover:border-slate-300 hover:bg-slate-50 text-slate-700 rounded-xl font-medium text-sm shadow-sm transition-all duration-200 hover:shadow-md"
                            >
                                {contact?.linkedin ? <Linkedin className="w-4 h-4 text-blue-600" /> : <Globe className="w-4 h-4 text-slate-500" />}
                    ...
                    {/* Tab Navigation */}
                    {contact && (
                        <div className="flex rounded-xl bg-slate-100/70 p-1.5 shadow-inner animate-in fade-in slide-in-from-bottom-2 duration-500 delay-75 fill-mode-both">
                            <button
                                onClick={() => setActiveTab("contact")}
                                className={cn(
                                    "flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200",
                                    activeTab === "contact"
                    ...
                    {activeTab === "contact" && contact && (
                        <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-5 space-y-4 animate-in fade-in zoom-in-95 duration-400 delay-100 fill-mode-both">
                            {/* Contact Header */}
                            ...
                            {/* Contact Details */}
                            <div className="rounded-2xl border border-slate-200/80 overflow-hidden bg-white shadow-sm mt-3">
                                {(contact.phone || isEditingContact) && (
                                    <div className="flex items-center gap-3 p-3.5 border-b border-slate-100 last:border-0 hover:bg-slate-50/50 transition-colors">
                                ...
                                {(isEditingContact ? (editContactData.additionalPhones?.length ?? 0) > 0 : (contact.additionalPhones && Array.isArray(contact.additionalPhones) && contact.additionalPhones.filter(Boolean).length > 0)) && (
                                    <div className="p-3.5 border-b border-slate-100 last:border-0 hover:bg-slate-50/50 space-y-2 transition-colors">
                                ...
                                {isEditingContact && (editContactData.additionalPhones?.length ?? 0) === 0 && (
                                    <div className="p-3.5 border-b border-slate-100 last:border-0 hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <div className="flex items-center gap-3 p-3.5 border-b border-slate-100 last:border-0 hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            {isEditingContact ? (
                                                ...
                                                <a
                                                    href={contact.linkedin!.startsWith("http") ? (contact.linkedin as string) : `https://${contact.linkedin}`}
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm p-5 space-y-4 animate-in fade-in zoom-in-95 duration-400 delay-100 fill-mode-both">
                            ...
                            <div className="rounded-2xl border border-slate-200/80 overflow-hidden bg-white shadow-sm mt-3">
                                    ...
                                    <div className="flex items-center gap-3 p-3.5 border-b border-slate-100 last:border-0 hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            {isEditingCompany ? (
                                                ...
                                                <a
                                                    href={company.website!.startsWith("http") ? (company.website as string) : `https://${company.website}`}
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                ...
                                <div className="grid grid-cols-2">
                                    <div className="flex items-center gap-2 p-3.5 border-b border-r border-slate-100 hover:bg-slate-50/50 transition-colors">
                                    ...
                                    <div className="flex items-center gap-2 p-3.5 border-b border-slate-100 hover:bg-slate-50/50 transition-colors">
                    ...
                    {/* Actions Section */}
                    <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200 fill-mode-both">
                                    ...
                                    <div className="space-y-1.5">
                                        <div className="flex flex-wrap gap-2">
                                            {statusOptions.map((opt) => {
                                                const colors = ACTION_RESULT_COLORS[opt.value] || ACTION_RESULT_COLORS.NO_RESPONSE;
                                                ...
                                                return (
                                                    <button
                                                        ...
                                                        onClick={() => {
                                                            ...
                                                            if (opt.value === "ENVOIE_MAIL") {
                                                                onOpenEmailModal?.();
                                                            }
                                                            if (opt.value === "MEETING_BOOKED" && clientBookingUrl && contactId) {
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200/60 shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300 fill-mode-both">
                        ...
                        <div className="p-4">
                            {actionsLoading ? (
                                ...
                                <div className="space-y-0 max-h-[350px] overflow-y-auto drawer-scrollbar pr-2 pl-1 mt-1">
                                    {actions.map((a, index) => {
                                        ...
                                        return (
                                            <div
                                                key={a.id}
                                                className="relative pl-6 pb-4 animate-in fade-in slide-in-from-bottom-2 duration-300 fill-mode-both"
                                                style={{ animationDelay: `${350 + index * 75}ms` }}
                                            >
                                                {/* Vertical line connecting events */}
                                                {!isLast && (
                                                    <div className="absolute top-6 bottom-0 left-[9px] w-[2px] -ml-[1px] bg-slate-100" />
                                                )}

                                                {/* Timeline dot */}
                                                <div className={cn("absolute left-0 top-1.5 w-[18px] h-[18px] rounded-full border-[3px] border-white shadow-sm z-10", colors.dot)} />
                                                    ...
                                                    <div className="flex items-center justify-between gap-3 px-3.5 py-3">
                                                        <div className="flex-1 min-w-0">
                                                            <div className="flex items-center gap-2 flex-wrap mb-0.5">
                                                                <span className={cn("text-sm font-bold tracking-tight", colors.text)}>
                                                    ...
                                                    {(a.note || a.voipSummary || (a.voipProvider && a.channel === "CALL")) && (
                                                        <div className={cn(
                                                            ...
                                                            {hasLongNote && (
                                                                <button
                                                                    onClick={() => toggleNoteExpand(a.id)}
                                                                    className="flex items-center gap-1 mt-2 text-[10px] font-medium text-indigo-600 hover:text-indigo-700 transition-colors ml-3"
                                                                >
                                                                    {isExpanded ? (
                                                                        <>
